...
public class OffersPagedAdapter extends PagedListAdapter<ModelOffer, OffersPagedAdapter.ItemViewHolder> {
    ...
    public OffersPagedAdapter(Context context, OnOfferItemListener listener, Fragment parent) {
        super(DIFF_CALLBACK);
    ...
    @NonNull
    @Override
    public OffersPagedAdapter.ItemViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        ...
        return new OffersPagedAdapter.ItemViewHolder(itemView);
    }

    @Override
    public void onBindViewHolder(@NonNull OffersPagedAdapter.ItemViewHolder holder, int position) {
    ...
    @Override
    public void onViewAttachedToWindow(@NonNull OffersPagedAdapter.ItemViewHolder holder) {
        super.onViewAttachedToWindow(holder);
        holder.bind();
    }

    @Override
    public void onViewDetachedFromWindow(@NonNull OffersPagedAdapter.ItemViewHolder holder) {
    ...
    class ItemViewHolder extends RecyclerView.ViewHolder implements View.OnClickListener {
        ...
        ItemViewHolder(OfferCellPagedBinding binding) {
