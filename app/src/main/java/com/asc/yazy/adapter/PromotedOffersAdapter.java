...
import com.asc.yazy.databinding.RvPromotedItemBinding;
...
public class PromotedOffersAdapter extends RecyclerView.Adapter<PromotedOffersAdapter.ViewHolder> {
    ...
    public PromotedOffersAdapter(Context context, List<ModelOffer> offersList, OnOfferItemListener listener, boolean isLoading) {
    ...
    @NonNull
    @Override
    public PromotedOffersAdapter.ViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        RvPromotedItemBinding binding = DataBindingUtil.inflate(LayoutInflater.from(parent.getContext()), R.layout.rv_promoted_item, parent, false);
        binding.setListener(listener);
        return new PromotedOffersAdapter.ViewHolder(binding);
    }

    @Override
    public void onBindViewHolder(@NonNull PromotedOffersAdapter.ViewHolder holder, int position) {
    ...
    @Override
    public void onViewAttachedToWindow(@NonNull PromotedOffersAdapter.ViewHolder holder) {
        super.onViewAttachedToWindow(holder);
        holder.bind();
    }

    @Override
    public void onViewDetachedFromWindow(@NonNull PromotedOffersAdapter.ViewHolder holder) {
    ...
    class ViewHolder extends RecyclerView.ViewHolder implements View.OnClickListener {
        private RvPromotedItemBinding binding;

        ViewHolder(RvPromotedItemBinding binding) {
        ...
        void setViewModel(ModelOffer offerModel) {
            if (binding != null) {
                ...
                if (isLoading) {
                    ...
                    binding.loaderListDestination.startShimmerAnimation();
                    ...
                    binding.loaderListDestination.stopShimmerAnimation();
                    ...
                    binding.tvListDestination.setBackground(null);
