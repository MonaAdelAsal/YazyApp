...
import com.asc.yazy.databinding.RvNOfferItemBinding;
...
public class NewOffersAdapter extends RecyclerView.Adapter<NewOffersAdapter.ViewHolder> {
    ...
    public NewOffersAdapter(Context context, List<ModelOffer> offersList, OnOfferItemListener listener, boolean isLoading) {
    ...
    @NonNull
    @Override
    public NewOffersAdapter.ViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        RvNOfferItemBinding binding = DataBindingUtil.inflate(LayoutInflater.from(parent.getContext()), R.layout.rv_n_offer_item, parent, false);
        binding.setListener(listener);
        return new NewOffersAdapter.ViewHolder(binding);
    }

    @Override
    public void onBindViewHolder(@NonNull NewOffersAdapter.ViewHolder holder, int position) {
    ...
    @Override
    public void onViewAttachedToWindow(@NonNull NewOffersAdapter.ViewHolder holder) {
        super.onViewAttachedToWindow(holder);
        holder.bind();
    }

    @Override
    public void onViewDetachedFromWindow(@NonNull NewOffersAdapter.ViewHolder holder) {
    ...
    class ViewHolder extends RecyclerView.ViewHolder implements View.OnClickListener {
        private RvNOfferItemBinding binding;

        ViewHolder(RvNOfferItemBinding binding) {
